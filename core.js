(function (global, factory) {
 ...
 const fill = (selecter, value) => {
   document.querySelector(selecter).value = value;
 };
  
 const autoFillLoginGen = (idSelecter, pwSelecter) => (id, pw) => {
   fill(idSelecter,id);
   fill(pwSelecter,pw);
 };
 
 const pathMove = (pathWithFirstSlash) => () => {
    window.location.herf = location.host + pathWithFirstSlash;
 };
 
 const pathOpen = (pathWithFirstSlash) => () => {
   window.open(location.host + pathWithFirstSlash, "_blank");
  };
